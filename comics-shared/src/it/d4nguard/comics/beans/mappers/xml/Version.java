...
import static it.d4nguard.comics.utils.Convert.toBool;
import static it.d4nguard.comics.utils.xml.XmlUtils.*;
import it.d4nguard.comics.utils.StringUtils;
import it.d4nguard.comics.utils.xml.XmlUtils;
			...
			public Element translate(Element root)
			{
				...
				for (int i = 0; i < nodes.getLength(); i++)
				{
					...
					if (node.getNodeType() == Node.ELEMENT_NODE)
					{
						...
						{
							log.log(Level.FINE, e.getParentNode().getNodeName());
							log.log(Level.FINE, XmlUtils.toString(e, false, true));
						}
					}
					else
					{
