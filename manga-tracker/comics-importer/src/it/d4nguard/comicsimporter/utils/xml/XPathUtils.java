...
package it.d4nguard.comicsimporter.utils.xml;
...
public class XPathUtils
{
	 ...
	 * <b>NOTE</b> as this version uses namespaces from the given context
	 * it can give unexpected results when using fixed prefixes in the xpath.
	 * Prefer using isMatch(Node, String, Map)
	 * 
	 * @param context
