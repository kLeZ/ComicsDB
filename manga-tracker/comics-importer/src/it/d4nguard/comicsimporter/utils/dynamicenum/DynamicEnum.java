 ...
 */
package it.d4nguard.comicsimporter.utils.dynamicenum;
...
/**
 * A factory for values of a class that can be treated as a enumeration. The
 * factory
 * provides the &quot;aggregate&quot; functionality inherent in a normal Java
 * <code>Enum</code>,
 * such as retrieval of all known enumerated values of this type.
 * <p>
 * The underlying objects that give rise to the enumeration (which can be seen
 * as a convenience representation of these objects) should implement
 * {@link DynamicEnumerable}.
 * <p>
 * Implementation of {@link DynamicEnum#compare(Object, Object)} should be
 * aligned with the &quot;natural&quot; ordering of the enum (as reflected by
 * {@link #ordinal(Object)}).
 * 
 * @param <E>
...
public interface DynamicEnum<E, D extends DynamicEnumerable<E>> extends Comparator<E>
{
	 ...
	 * 
	 * @param enumValue
	 *            the instance of the enum value class that should be checked
	 * @return <code>true</code> iff an enum constant equal to the given value
	 *         exists.
	 */
	 ...
	 * {@link Enum#ordinal()}.
	 * <p>
	 * Implementing classes are free to decide on the ordering - and thus the
	 * ordinals - of the enumeration values, provided that, for two enum values
	 * <code>e1</code> and <code>e2</code>,
	 * <code>ordinal(e1) == ordinal(e2)</code> iff <code>e1.equals(e2)</code>.
	 * 
	 * @param enumValue
	 *            the enum constant whose ordinal is required
	 ...
	 * <p>
	 * The returned set will contain the endpoints themselves, which may be
	 ...
	 * @return a set containing all of the elements in the range defined by the
	 *         two
	 *         specified endpoints
	 * @throws IllegalArgumentException
	 *             if either of the endpoints does not exist or
	 *             <code>from.compareTo(to) &gt; 0</code>
	 * @throws NullPointerException
	 *             if <code>from</code> or <code>to</code> is null
	 */
